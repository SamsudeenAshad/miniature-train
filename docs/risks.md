# Risk review — post v0.15.0 (SRS 18.1)

| ID | Risk | Status after v0.15.0 |
| --- | --- | --- |
...
New since v0.14.0: local-dev health ordering, compose restart policies, documented
stack; supply chain stays clean with residuals noted. Cluster apply remains the open proof.
