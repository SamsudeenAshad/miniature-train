# Risk review — post v0.20.0 (SRS 18.1)

| ID | Risk | Status after v0.20.0 |
| --- | --- | --- |
...
New since v0.19.0: envelope errors both services, version parity enforced,
release↔tag parity both directions. Cluster apply remains the open proof.
