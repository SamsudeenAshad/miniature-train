# Risk review — post v0.21.0 (SRS 18.1)

| ID | Risk | Status after v0.21.0 |
| --- | --- | --- |
...
New since v0.20.0: every documented command proven runnable in tests; quickstart
verified by execution. Cluster apply remains the open proof.
