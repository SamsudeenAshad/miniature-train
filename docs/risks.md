# Risk review — post v0.16.0 (SRS 18.1)

| ID | Risk | Status after v0.16.0 |
| --- | --- | --- |
...
New since v0.15.0: contracts carry live conformance tests; replay semantics fixed;
supply chain stays clean. Cluster apply remains the open proof.
