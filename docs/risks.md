# Risk review — post v0.25.0 (SRS 18.1)

| ID | Risk | Status after v0.25.0 |
| --- | --- | --- |
...
New since v0.24.0: contracts versioned with live conformance; runbook covers
contracts; guides verified. Cluster apply remains the open proof.
